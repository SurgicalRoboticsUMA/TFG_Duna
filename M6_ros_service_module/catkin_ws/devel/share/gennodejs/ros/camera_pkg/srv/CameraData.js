...
class CameraDataRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CameraDataRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CameraDataRequest
    let len;
    let data = new CameraDataRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CameraDataRequest(null);
...
class CameraDataResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CameraDataResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CameraDataResponse
    let len;
    let data = new CameraDataResponse(null);
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'camera_pkg/CameraDataResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CameraDataResponse(null);
    return resolved;
    }
};

module.exports = {
  Request: CameraDataRequest,
  Response: CameraDataResponse,
  md5sum() { return '728e20175689a0067ab9e0629d227334'; },
  datatype() { return 'camera_pkg/CameraData'; }
};
