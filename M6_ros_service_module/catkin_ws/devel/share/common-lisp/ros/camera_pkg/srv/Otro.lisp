...
(cl:defmethod cl:initialize-instance :after ((m <Otro-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Otro-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_pkg-srv:<Otro-request> is deprecated: use camera_pkg-srv:Otro-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <Otro-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_pkg-srv:a-val is deprecated.  Use camera_pkg-srv:a instead.")
  (a m))
...
(cl:defmethod cl:initialize-instance :after ((m <Otro-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Otro-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_pkg-srv:<Otro-response> is deprecated: use camera_pkg-srv:Otro-response instead.")))
